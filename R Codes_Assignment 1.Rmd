...
barplot(b1, main="Average Delay for destination", xlab="Delay (in mins)", ylab="Destination", horiz=TRUE, las=1,names.arg=c(a1) ,border="red")
#for mid 17 airports
barplot(b2, main="Average Delay for destination", xlab="Delay (in mins)", ylab="Destination", horiz=TRUE, las=1,names.arg=c(a2) ,border="red")
#for last 17 airports
barplot(b3, main="Average Delay for destination", xlab="Delay (in mins)", ylab="Destination", horiz=TRUE, las=1,names.arg=c(a3) ,border="red")
